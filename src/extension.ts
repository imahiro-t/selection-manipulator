...
export function activate(context: vscode.ExtensionContext) {
  ...
  context.subscriptions.push(vscode.commands.registerTextEditorCommand('selection-manipulator.date.era-conversion', japaneseEraHandler(false)));
  context.subscriptions.push(vscode.commands.registerTextEditorCommand('selection-manipulator.date.era-conversion.replace', japaneseEraHandler(true)));
  context.subscriptions.push(vscode.commands.registerTextEditorCommand('selection-manipulator.morse.to-morse', morseHandler('to-morse', 'new-tab')));
  context.subscriptions.push(vscode.commands.registerTextEditorCommand('selection-manipulator.morse.to-morse.replace', morseHandler('to-morse', 'replace')));
  context.subscriptions.push(vscode.commands.registerTextEditorCommand('selection-manipulator.morse.from-morse', morseHandler('from-morse', 'new-tab')));
  context.subscriptions.push(vscode.commands.registerTextEditorCommand('selection-manipulator.morse.from-morse.replace', morseHandler('from-morse', 'replace')));
  context.subscriptions.push(vscode.commands.registerTextEditorCommand('selection-manipulator.morse.from-morse.kana', morseHandler('from-morse', 'new-tab', 'kana')));
  context.subscriptions.push(vscode.commands.registerTextEditorCommand('selection-manipulator.morse.from-morse.kana.replace', morseHandler('from-morse', 'replace', 'kana')));
  context.subscriptions.push(vscode.commands.registerTextEditorCommand('selection-manipulator.date.to-iso', dateHandler('iso', 'new-tab')));
  context.subscriptions.push(vscode.commands.registerTextEditorCommand('selection-manipulator.date.to-iso.replace', dateHandler('iso', 'replace')));
  context.subscriptions.push(vscode.commands.registerTextEditorCommand('selection-manipulator.date.to-iso.clipboard', dateHandler('iso', 'clipboard')));
  context.subscriptions.push(vscode.commands.registerTextEditorCommand('selection-manipulator.date.to-locale', dateHandler('locale', 'new-tab')));
  context.subscriptions.push(vscode.commands.registerTextEditorCommand('selection-manipulator.date.to-locale.replace', dateHandler('locale', 'replace')));
  context.subscriptions.push(vscode.commands.registerTextEditorCommand('selection-manipulator.date.to-locale.clipboard', dateHandler('locale', 'clipboard')));
  context.subscriptions.push(vscode.commands.registerTextEditorCommand('selection-manipulator.date.to-timestamp', dateHandler('timestamp', 'new-tab')));
  context.subscriptions.push(vscode.commands.registerTextEditorCommand('selection-manipulator.date.to-timestamp.replace', dateHandler('timestamp', 'replace')));
  context.subscriptions.push(vscode.commands.registerTextEditorCommand('selection-manipulator.date.to-timestamp.clipboard', dateHandler('timestamp', 'clipboard')));
  context.subscriptions.push(vscode.commands.registerTextEditorCommand('selection-manipulator.date.to-timestamp-ms', dateHandler('timestamp-ms', 'new-tab')));
  context.subscriptions.push(vscode.commands.registerTextEditorCommand('selection-manipulator.date.to-timestamp-ms.replace', dateHandler('timestamp-ms', 'replace')));
  context.subscriptions.push(vscode.commands.registerTextEditorCommand('selection-manipulator.date.to-timestamp-ms.clipboard', dateHandler('timestamp-ms', 'clipboard')));
